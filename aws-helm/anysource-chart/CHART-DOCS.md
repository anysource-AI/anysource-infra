...
![Version: 0.18.1](https://img.shields.io/badge/Version-0.18.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.14.1](https://img.shields.io/badge/AppVersion-1.14.1-informational?style=flat-square)
...
| global.deployment.customerId | string | `""` |  |
| global.deployment.infraVersion | string | `""` |  |
...
| relay.config.logFormat | string | `"json"` |  |
| relay.config.logLevel | string | `"info"` |  |
| relay.config.mode | string | `"managed"` |  |
| relay.config.upstream | string | `"https://o4509836808028160.ingest.us.sentry.io"` |  |
| relay.enabled | bool | `true` |  |
| relay.hpa.enabled | bool | `true` |  |
| relay.hpa.maxReplicas | int | `6` |  |
| relay.hpa.minReplicas | int | `2` |  |
| relay.hpa.targetCPUUtilizationPercentage | int | `70` |  |
| relay.hpa.targetMemoryUtilizationPercentage | int | `80` |  |
| relay.image.pullPolicy | string | `"IfNotPresent"` |  |
| relay.image.pullSecrets | list | `[]` |  |
| relay.image.repository | string | `"ghcr.io/getsentry/relay"` |  |
| relay.image.tag | string | `"25.10.0"` |  |
| relay.livenessProbe.failureThreshold | int | `3` |  |
| relay.livenessProbe.httpGet.path | string | `"/api/relay/healthcheck/live/"` |  |
| relay.livenessProbe.httpGet.port | int | `3000` |  |
| relay.livenessProbe.initialDelaySeconds | int | `10` |  |
| relay.livenessProbe.periodSeconds | int | `30` |  |
| relay.livenessProbe.timeoutSeconds | int | `5` |  |
| relay.port | int | `3000` |  |
| relay.readinessProbe.failureThreshold | int | `3` |  |
| relay.readinessProbe.httpGet.path | string | `"/api/relay/healthcheck/ready/"` |  |
| relay.readinessProbe.httpGet.port | int | `3000` |  |
...
| relay.secrets.id | string | `"your-relay-id-here"` |  |
| relay.secrets.public_key | string | `"your-relay-public-key-here"` |  |
| relay.secrets.secret_key | string | `"your-relay-secret-key-here"` |  |
| relay.vault.enabled | bool | `true` |  |
